...
@Service
@AllArgsConstructor
public class ChargeMigrationService {
    ...
    public String init() {
        ...
        for( String[] fields : loader.readData( "charge.csv")) {
        ...
        return String.format( "%-40s %16s", "Charges migration complete, added: ", added+ "/"+ total);
    }
}
