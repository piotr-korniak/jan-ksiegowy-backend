...
@SecondaryTable( name= PayrollPayslip.TABLE_NAME, pkJoinColumns= @PrimaryKeyJoinColumn( name="DOCUMENT_ID"))
public abstract class PayrollPayslip {
    ...
    public PayrollPayslip setDates(LocalDate date, LocalDate due) {
        this.settlementDate= date;
        this.settlementDue= due;
        return this;
    }

    public PayrollPayslip setAmount(BigDecimal amount) {
        this.ct= amount;
        return this;
    }
